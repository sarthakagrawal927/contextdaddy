...
parser.add_argument("--version", default="0.1.0", help="Numeric public version")
parser.add_argument("--build", type=int, default=1, help="Positive, increasing build number")
args = parser.parse_args()
if not re.fullmatch(r"\d+(?:\.\d+)*", args.version) or args.build < 1:
